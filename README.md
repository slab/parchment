...
**Note:** You should never instantiate a Blot yourself with `new`. This may prevent necessary [lifecycle](#lifecycle) functionality of a Blot. Use the [Registry](#registry)'s `create()` method instead.
